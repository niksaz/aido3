...
class CNNNetwork:
    ...
    def __setup_output(self):
        with tf.variable_scope('ConvNet', reuse=tf.AUTO_REUSE):
            ...
            # bn_conv_1 = tf.layers.batch_normalization(hl_conv_1, training=self.is_train)
            ...
            # bn_conv_2 = tf.layers.batch_normalization(hl_conv_2, training=self.is_train)
            ...
            # bn_fc_1 = tf.layers.batch_normalization(hl_fc_1, training=self.is_train)
            ...
            # conv_layer_block_1 = self.__build_conv_block(x_normed, kernel_size=5, filters=4, name='conv1')
            ...
            # flatten tensor to connect it with the fully connected layers
            # conv_flat = tf.layers.flatten(conv_layer_block_1)
